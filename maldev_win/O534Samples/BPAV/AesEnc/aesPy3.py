...
# pip install pycryptodome (cryptodome or pycryptodomex)
# Ex usage: python3 aes256_encrypt.py payload_unenc.ico -of payload_enc.ico
# https://github.com/RedSiege/Chromatophore/blob/main/AES/README.md
...
print(f'key lenght [{ len(key) }]')
print(f'payload lenght [{ len(ciphertext) }]')
