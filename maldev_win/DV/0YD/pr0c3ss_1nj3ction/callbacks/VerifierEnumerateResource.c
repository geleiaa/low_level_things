...
typedef ULONG(WINAPI* VerifierEnumResourceFn)(HANDLE Process, ULONG Flags, ULONG ResourceType, AVRF_RESOURCE_ENUMERATE_CALLBACK ResourceCallback, PVOID EnumerationContext);
...
int main() {
    ...
    HMODULE hverfier = LoadLibraryA("verifier.dll");
    VerifierEnumResourceFn VerifierEnumResource = (VerifierEnumResourceFn) GetProcAddress(hverfier,"VerifierEnumerateResource");
