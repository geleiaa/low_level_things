...
int main() {
    ...
    char dummy[MAX_PATH];
    SymFindFileInPath(GetCurrentProcess(), "C:\\windows\\system32", "kernel32.dll", &finfo.timestamp, finfo.size, 0, SSRVOPT_DWORDPTR, dummy, (PFINDFILEINPATHCALLBACK)address, NULL);
    return 0;
}